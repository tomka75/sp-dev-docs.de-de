...
groupId                 |string          |ja     |Die Gruppen-ID bestimmt, welche Toolboxgruppe das Webpart enthalten soll. Das clientseitige Framework enthält reservierte Gruppen-IDs für vordefinierte Gruppen. Der Entwickler kann eine dieser Gruppen auswählen.|`"groupId": "cf066440-0614-43d6-98ae-0b31cf14c7c3"`
group                   |ILocalizedString|nein      |Mithilfe dieses Felds wird bestimmt, welche Toolboxgruppe das Webpart in der Erstellungsoberfläche enthalten soll. Auf klassischen Seiten entspricht der Webpartkatalog der Toolbox. Wenn Sie eine GUID als Gruppen-ID wählen (wie in der folgenden Tabelle), verwenden Sie den entsprechenden Kategorienamen für die klassische Seite aus der vordefinierten Gruppe.|`"group": { "default": "Media and Content" }`
...
Kategoriename |Guid |Entsprechender Kategoriename der klassischen Seite |Beschreibung        
--- |--- |--- |---
...
Suche | `1edbd9a8-0bfb-4aa2-9afd-14b8c45dd489`| Suche  |Diese Kategorie enthält Webparts, die Inhalte organisieren, gruppieren und filtern, um Benutzer bei der Suche nach Informationen zu helfen. 

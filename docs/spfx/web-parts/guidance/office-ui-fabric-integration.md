...
Es gibt zwei Teile von Office UI Fabric, die voraussichtlich von Entwicklern verwendet werden:
...
Eines der Ziele von SharePoint Framework besteht darin, Microsoft und Kunden das Erstellen vielfältiger, ansprechender und konsistenter Lösungen über SharePoint hinaus zu ermöglichen. Basierend darauf finden Sie nachfolgend unsere Entwurfsgrundsätze:
...
## <a name="how-to-use-office-ui-fabric-react-in-safe-way-in-your-web-part"></a>Sicheres Verwenden von Office UI Fabric React in Ihrem Webpart
...
- Webpartentwickler müssen eine explizite Abhängigkeit von einer bestimmten Version von Fabric React, Version 2.0, in der package.json-Datei „office-ui-fabric-react“:„2.0.0“ verwenden. Beachten Sie, dass ältere Versionen von Fabric React als Version 2.x nicht unterstützt werden.

...
- **react-Lokalisierung** als Ihr Lösungsname.
...
Öffnen Sie im Code-Editor die **./src/webparts/greeting/IGreetingWebPartProps.ts**-Datei, und fügen Sie den folgenden Code ein:
...
Öffnen Sie als Nächstes die **./src/webparts/greeting/GreetingWebPart.ts**-Datei und ändern Sie die **GreetingWebPart**-Klasse folgendermaßen:
...
Sobald Textfelder für alle aktivierten Sprachen erstellt werden, aktualisiert die Methode den Eigenschaftenbereich durch Aufrufen der **efreshPropertyPane**Methode. Zum Schluss entfernt die Methode die Webpart-Ladeanzeige und erstellt den Textkörper des Webparts neu.
...
Durch Untersuchen des aktuellsten im Release-Build generierten Webpart-Manifest werden Sie feststellen, dass das **greetingStrings**-Modul nun die Referenzen zu allen unterstützten Gebietsschemas enthält.

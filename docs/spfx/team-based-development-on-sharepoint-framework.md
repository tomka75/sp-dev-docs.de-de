<a id="team-based-development-on-the-sharepoint-framework" class="xliff"></a>

# Teambasierte Entwicklung mit dem SharePoint Framework
...
<a id="preparing-the-development-environment" class="xliff"></a>
...
<a id="sharepoint-framework-toolchain" class="xliff"></a>
...
<a id="yeoman-and-sharepoint-framework-yeoman-generator" class="xliff"></a>

#### Yeoman und der Yeoman-Generator von SharePoint Framework
...
<a id="building-a-sharepoint-framework-development-environment" class="xliff"></a>

### Erstellen einer SharePoint Framework-Entwicklungsumgebung
...
<a id="shared-or-a-personal-development-environment" class="xliff"></a>

#### Freigegebene oder persönliche Entwicklungsumgebung
...
<a id="developing-on-the-host" class="xliff"></a>

#### Entwickeln auf dem Host
...
<a id="developing-in-a-virtual-machine" class="xliff"></a>

#### Entwickeln auf einem virtuellen Computer
...
<a id="developing-using-docker" class="xliff"></a>
...
Lesen Sie weitere Informationen [zur Verwendung von Docker zum Erstellen von SharePoint Framework-Lösungen](https://rencore.com/blog/try-sharepoint-framework-without-installing).

<a id="development-workflow-in-sharepoint-framework-projects" class="xliff"></a>

## Entwicklungsworkflow in SharePoint Framework-Projekten
...
<a id="create-new-sharepoint-framework-project" class="xliff"></a>
...
<a id="lock-dependencies-version" class="xliff"></a>

### Sperren der Abhängigkeitenversion
...
<a id="add-the-project-to-source-control" class="xliff"></a>

### Hinzufügen des Projekts zur Quellcodeverwaltung
...
<a id="get-the-project-from-source-control" class="xliff"></a>

### Abrufen des Projekts aus der Quellcodeverwaltung
...
<a id="add-packages-to-your-project" class="xliff"></a>

### Hinzufügen von Paketen zum Projekt
...
<a id="working-with-internal-packages" class="xliff"></a>

## Arbeiten mit internen Paketen
...
<a id="hosting-private-package-registry" class="xliff"></a>

### Hosten einer privaten Paketregistrierung
...
<a id="linking-packages-using-npm-link" class="xliff"></a>

### Verknüpfen von Paketen mithilfe der npm-Verknüpfung
...
<a id="combining-private-package-registry-and-linking-packages" class="xliff"></a>

### Kombinieren der privaten Paketregistrierung und der Verknüpfung von Paketen
...
<a id="ensuring-code-consistency-and-quality" class="xliff"></a>

## Sicherstellen von Codekonsistenz und -qualität
...
<a id="choose-javascript-library-for-your-team-and-use-coding-standards" class="xliff"></a>

### Auswählen der JavaScript-Bibliothek für Ihr Team und Verwenden von Codestandards
...
<a id="enforce-coding-standards-and-policies-throughout-the-whole-lifecycle-of-your-solution" class="xliff"></a>

### Erzwingen von Codierungsstandards und Richtlinien über den gesamten Lebenszyklus Ihrer Lösung
...
<a id="automated-testing" class="xliff"></a>
...
<a id="code-analysis" class="xliff"></a>
...
<a id="upgrading-sharepoint-framework-projects" class="xliff"></a>

## Aktualisieren von SharePoint Framework-Projekten
...
<a id="semantic-versioning-semver" class="xliff"></a>
...
<a id="increase-version-number" class="xliff"></a>
...
<a id="increase-package-version-in-packagejson" class="xliff"></a>

#### Erhöhen der Paketversion in „packet.json“
...
<a id="increase-solution-package-version-in-package-solutionjson" class="xliff"></a>

#### Erhöhen der Lösungspaketversion in „package-solution.json“
...
<a id="increase-web-part-version-in-the-web-part-manifest" class="xliff"></a>

#### Erhöhen der Webpartversion im Webpartmanifest
...
<a id="update-dependencies" class="xliff"></a>
...
<a id="build-and-package-project-in-release-mode" class="xliff"></a>

### Erstellen und Verpacken des Projekts im Releasemodus
...
<a id="deploy-new-version-of-your-solution" class="xliff"></a>

### Bereitstellen der neuen Version Ihrer Lösung

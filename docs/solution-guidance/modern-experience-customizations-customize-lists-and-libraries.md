...
---
# <a name="customizing-modern-lists-and-libraries"></a>Customizing "modern" lists and libraries
...
## <a name="overview-of-customization-options"></a>Overview of customization options
...
## <a name="user-custom-actions"></a>User custom actions
...
### <a name="editcontrolblock-user-custom-actions"></a>EditControlBlock user custom actions 
...
### <a name="commanduiribbon-user-custom-actions"></a>CommandUI.Ribbon user custom actions 
...
### <a name="user-custom-action-limitations"></a>User custom action limitations 
...
## <a name="custom-branding"></a>Custom branding
...
## <a name="configure-the-end-user-experience"></a>Configure the end user experience

You have multiple options to control whether the "modern" or "classic" library and list experience is used. 

### <a name="tenant-level-configuration"></a>Tenant level configuration
...
### <a name="siteweb-level-configuration"></a>Site/Web level configuration
...
### <a name="listlibrary-configuration"></a>List/Library configuration
...
<a name="autodetect"> </a>
## <a name="when-does-the-built-in-auto-detect-automatically-switch-rendering-back-to-classic"></a>When does the built-in auto-detect automatically switch rendering back to "classic"?
...
### <a name="programmatically-detect-if-your-librarylist-will-be-shown-using-modern-or-classic"></a>Programmatically detect if your library/list will be shown using "modern" or "classic" 
...
#### <a name="csom-sample"></a>CSOM sample

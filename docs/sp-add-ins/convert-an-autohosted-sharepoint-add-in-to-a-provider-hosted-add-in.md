...
### <a name="core-concepts-to-know"></a>Kernkonzepte, die Sie kennen sollten
...
Für das Konvertieren eines automatisch gehosteten SharePoint-Add-Ins in ein vom Anbieter gehostetes Add-In sind mehrere Schritte erforderlich, die jeweils in den folgenden Abschnitten dargestellt sind.
...
### <a name="deploy-the-azure-sql-database"></a>Bereitstellen der Azure SQL-Datenbank
...
#### <a name="creating-and-deploying-the-azure-sql-database"></a>Erstellen und Bereitstellen der Azure SQL-Datenbank
...
**Abrufen von Azure SQL-Datenbankverbindungszeichenfolgen aus dem Azure-Verwaltungsportal**
...
### <a name="create-an-azure-web-site"></a>Erstellen einer Azure-Website
...
### <a name="register-a-new-add-in"></a>Registrieren eines neuen Add-Ins
...
### <a name="remote-web-application--azure-web-site-configuration-changes"></a>Remotewebanwendung/Azure-Website - Änderungen der Konfiguration
...
#### <a name="update-the-remote-web-application-project"></a>Aktualisieren des Remote-Webanwendungsprojekts
...
#### <a name="deploying-the-remote-web-application-to-the-azure-web-site"></a>Bereitstellen der Remotewebanwendung an die Azure-Website
 ...
 **Hinweis** Zusätzliche Optionen für das Bereitstellen von ASP.NET-Webanwendungen an eine Azure-Website finden Sie in der Azure-Dokumentation: [Bereitstellen einer Microsoft Azure-Website](http://azure.microsoft.com/documentation/articles/web-sites-deploy).
...
#### <a name="custom-domains-and-ssl-certificates-for-azure-web-sites"></a>Benutzerdefinierte Domänen und SSL-Zertifikate für Azure-Websites
...
### <a name="reconfiguring-the-sharepoint-add-in-project"></a>Erneutes Konfigurieren des SharePoint-Add-In-Projekts
 ...
 **Wichtig** Würde die vorhandene Produkt-ID verwendet werden, würde SharePoint die Fehlermeldung „Das bereitgestellte Add-In unterscheidet sich von einem anderen Add-In mit der gleichen Version und Produkt-ID“ zurückgeben, wenn das konvertierte Add-In installiert wird.

...
| `nbf`|<span data-ttu-id="14140-250">Wie bei Benutzer-und-Add-In-Token oben.</span><span class="sxs-lookup"><span data-stu-id="14140-250">Same as the user+add-in token above.</span></span>|<span data-ttu-id="14140-251">1403304705</span><span class="sxs-lookup"><span data-stu-id="14140-251">1403304705</span></span>|
...
<span data-ttu-id="14140-p151">Die Ansprüche **aud**, **iss**, **nbf** und **exp** sind exakt die gleichen wie bei einem Zugriffstoken und sind weiter oben erläutert. Die Ansprüche **appctxsender**, **appctx**, **CacheKey**, **SecurityTokenServiceUri**, **refreshtoken** und **isbrowserhostedapp** werden in der folgenden Tabelle beschrieben.</span><span class="sxs-lookup"><span data-stu-id="14140-p151">The  **aud**, **iss**, **nbf**, and **exp** claims are exactly the same as in an access token as described above. The **appctxsender**, **appctx**, **CacheKey**, **SecurityTokenServiceUri**, **refreshtoken**, and **isbrowserhostedapp** claims are described in the following table.</span></span>
 

 

<span data-ttu-id="14140-353">**Tabelle 3: Kontexttokenansprüche und -informationen**</span><span class="sxs-lookup"><span data-stu-id="14140-353">**Table 3. Context token claims and information**</span></span>


|<span data-ttu-id="14140-354">** **Anspruch****</span><span class="sxs-lookup"><span data-stu-id="14140-354">** **Claim****</span></span>|<span data-ttu-id="14140-355">** **Beschreibung****</span><span class="sxs-lookup"><span data-stu-id="14140-355">** **Description****</span></span>|<span data-ttu-id="14140-356">**.**Entsprechender Wert im Beispielkontexttoken****</span><span class="sxs-lookup"><span data-stu-id="14140-356">** **Corresponding value in sample context token****</span></span>|
|:-----|:-----|:-----|
|<span data-ttu-id="14140-357">aud</span><span class="sxs-lookup"><span data-stu-id="14140-357">aud</span></span>||<span data-ttu-id="14140-358">a044e184-7de2-4d05-aacf-52118008c44e/fabrikam.com@040f2415-e6e3-4480-96ce-26ef73275f73</span><span class="sxs-lookup"><span data-stu-id="14140-358">a044e184-7de2-4d05-aacf-52118008c44e/fabrikam.com@040f2415-e6e3-4480-96ce-26ef73275f73</span></span>|
|<span data-ttu-id="14140-359">iss</span><span class="sxs-lookup"><span data-stu-id="14140-359">iss</span></span>||<span data-ttu-id="14140-360">00000001-0000-0000-c000-000000000000@040f2415-e6e3-4480-96ce-26ef73275f73</span><span class="sxs-lookup"><span data-stu-id="14140-360">00000001-0000-0000-c000-000000000000@040f2415-e6e3-4480-96ce-26ef73275f73</span></span>|
|<span data-ttu-id="14140-361">nbf</span><span class="sxs-lookup"><span data-stu-id="14140-361">nbf</span></span>||<span data-ttu-id="14140-362">1335822895</span><span class="sxs-lookup"><span data-stu-id="14140-362">1335822895</span></span>|
|<span data-ttu-id="14140-363">exp</span><span class="sxs-lookup"><span data-stu-id="14140-363">exp</span></span>||<span data-ttu-id="14140-364">1335866095</span><span class="sxs-lookup"><span data-stu-id="14140-364">1335866095</span></span>|
|<span data-ttu-id="14140-365">appctxsender</span><span class="sxs-lookup"><span data-stu-id="14140-365">appctxsender</span></span>|<span data-ttu-id="14140-p152">Kurz für „application context sender“ (Absender des Anwendungskontexts). Dies stellt die Anwendung dar, die das Kontexttoken an das SharePoint-Add-In gesendet hat. Sie hat das Format _GUID des Prinzipals_@ _SharePoint-Bereich_, wobei _GUID des Prinzipals_ die konstante ID des Anwendungsprinzipals ist; entweder SharePoint, Exchange 2013, Lync 2013 oder Workflow.</span><span class="sxs-lookup"><span data-stu-id="14140-p152">Short for "application context sender". It represents the application that sent the context token to the SharePoint Add-in.It has the form  _GUID of principal_@ _SharePoint realm_, where  _GUID of principal_ is the constant ID of the application principal; either SharePoint, Exchange 2013, Lync 2013, or Workflow.</span></span>|<span data-ttu-id="14140-368">00000003-0000-0ff1-ce00-000000000000@040f2415-e6e3-4480-96ce-26ef73275f73</span><span class="sxs-lookup"><span data-stu-id="14140-368">00000003-0000-0ff1-ce00-000000000000@040f2415-e6e3-4480-96ce-26ef73275f73</span></span>|
|<span data-ttu-id="14140-369">appctx</span><span class="sxs-lookup"><span data-stu-id="14140-369">appctx</span></span>|<span data-ttu-id="14140-p153">Abkürzung für „add-in context“ (Add-In-Kontext), ein JSON-Objekt, das **CacheKey** und **SecurityTokenServiceURI** enthält.</span><span class="sxs-lookup"><span data-stu-id="14140-p153">Short for "add-in context". It is a JSON object that contains the  **CacheKey** and **SecurityTokenServiceURI**.</span></span>|<span data-ttu-id="14140-372">\"CacheKey\":\"KQAIUpDUD0sm5Tr83U+jZGYVuPPCPu8BGwoWiAACqNw=\", \"SecurityTokenServiceUri\":\"https://accounts.accesscontrol.windows-int-sn1-004.accesscontrol.aadint.windows-int.net/tokens/OAuth/2\"</span><span class="sxs-lookup"><span data-stu-id="14140-372">\"CacheKey\":\"KQAIUpDUD0sm5Tr83U+jZGYVuPPCPu8BGwoWiAACqNw=\", \"SecurityTokenServiceUri\":\"https://accounts.accesscontrol.windows-int-sn1-004.accesscontrol.aadint.windows-int.net/tokens/OAuth/2\"</span></span>|
|<span data-ttu-id="14140-373">CacheKey</span><span class="sxs-lookup"><span data-stu-id="14140-373">CacheKey</span></span>|<span data-ttu-id="14140-p154">Ein eindeutiger Wert, der als Schlüssel in jedem nach Schlüssel/Wert strukturierten Cache verwendet werden kann, um das Kontexttoken zu speichern und abzurufen. Er kann auch als Wert einer Schlüsselspalte in einer Zeile einer Datenbank verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="14140-p154">A unique value that can be used as the key in any key/value structured cache to store and retrieve the context token. It could also be used as the value of a key column in a row of a database.</span></span>|<span data-ttu-id="14140-376">KQAIUpDUD0sm5Tr83U+jZGYVuPPCPu8BGwoWiAACqNw=</span><span class="sxs-lookup"><span data-stu-id="14140-376">KQAIUpDUD0sm5Tr83U+jZGYVuPPCPu8BGwoWiAACqNw=</span></span>|

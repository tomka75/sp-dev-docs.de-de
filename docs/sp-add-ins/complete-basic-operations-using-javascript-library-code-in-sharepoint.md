...
Sie können das SharePoint-Clientobjektmodell zum Abrufen, Aktualisieren und Verwalten von Daten in SharePoint verwenden. SharePoint macht das Objektmodell in verschiedener Form verfügbar.
...
Weitere Information zu den Gruppen von APIs, die für SharePoint verfügbar sind, finden Sie unter [Auswählen des richtigen API-Satzes in SharePoint](http://msdn.microsoft.com/library/f36645da-77c5-47f1-a2ca-13d4b62b320d%28Office.15%29.aspx). 
...
## <a name="perform-basic-tasks-in-sharepoint-using-the-javascript-client-object-model"></a>Ausführen grundlegender Aufgaben in SharePoint unter Verwendung des JavaScript-Clientobjektmodells
...
### <a name="write-to-a-websites-properties"></a>Festlegen der Eigenschaften einer Website
...
### <a name="retrieve-all-properties-of-all-lists-in-a-website"></a>Abrufen aller Eigenschaften aller Listen einer Website
...
### <a name="retrieve-only-specified-properties-of-lists"></a>Abrufen der angegebenen Eigenschaften von Listen
...
### <a name="store-retrieved-lists-in-a-collection"></a>Speichern abgerufener Listen in einer Auflistung
...
### <a name="apply-filters-to-list-retrieval"></a>Anwenden von Filtern auf den Listenabruf
...
## <a name="create-update-and-delete-lists"></a>Erstellen, Aktualisieren und Löschen von Listen
...
### <a name="create-and-update-a-list"></a>Erstellen und Aktualisieren von Listen
...
### <a name="add-a-field-to-a-list"></a>Hinzufügen von Feldern zu einer Liste
...
## <a name="create-update-and-delete-folders"></a>Erstellen, Aktualisieren und Löschen von Ordnern
...
### <a name="create-a-folder-in-a-document-library"></a>Erstellen eines Ordners in einer Dokumentbibliothek
...
### <a name="update-a-folder-in-a-document-library"></a>Aktualisieren eines Ordners in einer Dokumentbibliothek
...
### <a name="delete-a-folder-in-a-document-library"></a>Löschen eines Ordners in einer Dokumentbibliothek
...
## <a name="create-read-update-and-delete-files"></a>Erstellen, Lesen, Aktualisieren und Löschen von Dateien
...
### <a name="create-a-file-in-a-document-library"></a>Erstellen einer Datei in einer Dokumentbibliothek
...
### <a name="read-a-file-in-a-document-library"></a>Lesen einer Datei in einer Dokumentbibliothek
...
### <a name="update-a-file-in-a-document-library"></a>Aktualisieren einer Datei in einer Dokumentbibliothek
...
### <a name="delete-a-file-in-a-document-library"></a>Löschen einer Datei in einer Dokumentbibliothek
...
### <a name="retrieve-items-from-a-list"></a>Abrufen von Listenelementen
...
### <a name="use-the-include-method-to-access-properties-of-listitem-objects"></a>Zugreifen auf Eigenschafen von ListItem-Objekten mit der Include-Methode
 ...
 **Hinweis** Wenn Sie mit LINQ das Clientobjektmodell abfragen, verwenden Sie [LINQ to Objects](http://msdn.microsoft.com/library/bb397919), nicht den [LINQ to SharePoint-Anbieter](http://msdn.microsoft.com/library/ee535491), der nur in Code zum Abfragen des Serverobjektmodells verwendet werden kann.
...
### <a name="restrictions-on-retrieving-items"></a>Beschränkungen beim Abrufen von Elementen
...
## <a name="create-update-and-delete-list-items"></a>Erstellen, Aktualisieren und Löschen von Listenelementen
...
### <a name="create-a-list-item"></a>Erstellen eines Listenelements

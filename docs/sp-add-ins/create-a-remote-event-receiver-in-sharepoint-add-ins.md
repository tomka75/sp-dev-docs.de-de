...
## <a name="create-a-remote-event-receiver"></a>Erstellen eines Remoteereignisempfängers
<a name="MakeRER"> </a>
...
### <a name="to-create-the-list"></a>So erstellen Sie die Liste
...
## <a name="run-and-test-the-event-handler"></a>Ausführen und Testen des Ereignishandlers
<a name="RunAndTest"> </a>
...
2. Vertrauen Sie dem Add-In, wenn Sie dazu aufgefordert werden.
    ...
    Ihr SharePoint-Add-In wird ausgeführt, und eine Tabelle mit verfügbaren Listen wird angezeigt und enthält **List1**.
...
5. Geben Sie im Feld **Element hinzufügen** den Wert „Erstes Element“ ein, und klicken Sie anschließend auf **Element hinzufügen**.
...
## <a name="add-or-remove-event-handlers-using-visual-studio"></a>Hinzufügen oder Entfernen von Ereignishandlern mit Visual Studio
<a name="Handle"> </a>
...
2. Legen Sie im Bereich **Eigenschaften** die Eigenschaften von Ereignissen, die Sie behandeln möchten, auf **True** fest.
    ...
    Wenn Sie beispielsweise darauf reagieren möchten, wenn ein Benutzer ein Listenelement hinzufügt, legen Sie die Eigenschaft **Handle ItemAdding** auf **True** fest. Wenn Sie dieses Ereignis nicht behandeln möchten, legen Sie diese Eigenschaft auf **False** fest.
...
## <a name="url-and-hosting-restrictions-for-production-remote-event-receivers"></a>URL- und Hostingeinschränkungen für Remoteereignisempfänger in der Produktion
<a name="Handle"> </a>

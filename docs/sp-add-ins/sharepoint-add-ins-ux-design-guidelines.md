...
```
  ...
  - Kopieren Sie die Bibliothek auf Ihre eigene Website und verweisen Sie dort auf sie.
     ...
     **Vorsicht** Wenn Sie sich für diese Alternative entscheiden, kann Ihr Add-In keine Aktualisierungen des Steuerelements nutzen
...
### <a name="creating-a-custom-branded-ui-in-sharepoint-add-ins"></a>Erstellen ein benutzerdefiniertes Branding-Benutzeroberfläche in SharePoint-Add-Ins
...
- Für Benutzer einer **zeitlich unbegrenzten** Testversion: Dies ist eine Testversion von _<app name>_. Hier können Sie die Vollversion erwerben und _<paid functionality>_ freischalten.
    
 
- Für Benutzer einer **noch nicht abgelaufenen, zeitlich begrenzten Testversion**: In _<Zeitraum, ausgedrückt durch eine leicht verständliche Zahlenangabe wie „3 Tage“, nicht „73:42:12“>_ läuft diese Testversion von _<app name>_ ab. Hier können Sie die Vollversion erwerben, um den ganzen Funktionsumfang nutzen zu können.
...
- Für Benutzer **ohne Lizenz**: Leider besitzen Sie keine Lizenz für _<app name>_. Hier können Sie die Vollversion erwerben und _<paid functionality>_ aktivieren.

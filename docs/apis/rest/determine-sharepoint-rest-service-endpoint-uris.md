...
### <a name="navigate-to-the-specific-resources-you-want-to-access"></a>Navigieren zu den Ressourcen, auf die Sie zugreifen möchten
...
Die folgende Abbildung veranschaulicht die SharePoint-Syntax für REST-Parameter.
 
**SharePoint-Syntax für REST-Parameter**
![SharePoint-Syntax für die Parameter für REST-Methoden](../../images/REST_parameterSyntax.png)
...
**Syntax für das Parameteraliasing im SharePoint-REST-Dienst**
![Syntax für das Parameteraliasing im SharePoint-REST-Dienst](../../images/REST_parameterAliasSyntax.png)

### <a name="specifying-dictionaries-as-parameter-values"></a>Angeben von Schlüsselverzeichnissen als Parameterwerte
...
**Syntax für Schlüsselverzeichnisparameter im REST-Dienst**
![Syntax für Schlüsselverzeichnisparameter im REST-Dienst](../../images/REST_parameterDictionarySyntax.png)
...
Die Abbildung unten veranschaulicht die Syntax, die der REST-Dienst für Parameter in einer Abfragezeichenfolge verwendet. 

**REST-Dienst-Syntax für Parameter in Abfragezeichenfolgen**
![](../../images/REST_parameterQuerySyntax.png)
...
Die Abbildung unten veranschaulicht die Syntax, die der SharePoint-REST-Dienst für statische Elemente verwendet.

**SharePoint-REST-Dienst-Syntax für statische Elemente**
![REST-Dienst-Syntax für Parameter in einer Abfragezeichenfolge](../../images/REST_parameterQuerySyntax.png)

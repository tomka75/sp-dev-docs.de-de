...
## <a name="create-an-app-for-sharepoint-and-duet-enterprise-20"></a>Erstellen einer app für SharePoint und Duet Enterprise 2.0
...
### <a name="to-create-an-app-for-sharepoint"></a>So erstellen eine app für SharePoint:
...
4. Wählen Sie **die App für SharePoint**.
...
7. Klicken Sie im Menü „Erstellen“ auf *\<Name Ihrer App\>* **bereitstellen**.
    
  
Sobald die App bereitgestellt wurde, öffnet Visual Studio die Standardseite der App.
  
    
    

## <a name="add-the-external-content-type-and-external-lists-to-the-app"></a>Fügen Sie den externen Inhaltstyp und externe Listen der App
...
3. Legen Sie einen Namen für die ODATA-Quelle fest, zum Beispiel „SAPWorkflows“. Klicken Sie anschließend auf **Weiter**.
...
## <a name="add-a-custom-action-feature-to-a-duet-enterprise-20-workflow-list"></a>Hinzufügen einer benutzerdefinierten Aktion zu einer Duet Enterprise 2.0-Workflowliste
...
### <a name="to-add-a-custom-action"></a>So fügen Sie eine benutzerdefinierte Aktion hinzu:
...
Wenn Sie die App nun bereitstellen und in der App zu **Lists/WorkflowTaskCollection** wechseln, wird die folgende Meldung angezeigt:
...
## <a name="add-single-sign-on-security-to-the-app"></a>Sicherheit für einmaliges Anmelden an die app hinzufügen
...
### <a name="to-add-single-sign-on"></a>So fügen Sie einmaliges Anmelden hinzu:
...
## <a name="access-workflow-tasks-and-associated-items-using-jsom"></a>Access-Workflowaufgaben und zugehörigen Elemente mit JSOM
...
### <a name="to-create-the-code"></a>So erstellen Sie den Code:
...
## <a name="using-html-and-javascript-to-render-custom-ui"></a>Mithilfe von HTML und JavaScript zum Rendern von Custom UI
<a name="bkmk_UseJSOM"> </a>
...
## <a name="adding-lync-control-to-your-details-page"></a>Hinzufügen von Lync-Steuerelement auf der Detailseite an
<a name="bkmk_UseJSOM"> </a>
...
### <a name="to-add-a-lync-control"></a>So fügen Sie ein Lync-Steuerelement hinzu:
...
2. Das folgende Markup wird:
  ...
  - Lync-Integration in Legende für Teilnehmer für die Zusammenarbeit mit einem Klick für den Vorgang.
    ...
    Fügen Sie den nachfolgenden Code auf der Seite **People.js** ein.

...
---
# <a name="excel-services-known-issues-and-tips"></a>Bekannte Probleme und Tipps für Excel Services
...
### <a name="viewing-the-wsdl-location"></a>Viewing the WSDL Location
...
### <a name="understanding-excel-web-services-and-namespaces"></a>Understanding Excel Web Services and Namespaces
...
### <a name="linking-locally-or-to-a-web-service"></a>Linking Locally or to a Web Service
...
### <a name="understanding-invalid-characters"></a>Understanding Invalid Characters
...
### <a name="understanding-the-url-property-of-an-excel-web-services-proxy-class"></a>Understanding the Url Property of an Excel Web Services Proxy Class
...
## <a name="understanding-security"></a>Understanding Security


### <a name="using-workbook-permissions"></a>Using Workbook Permissions
...
### <a name="trusted-location"></a>Trusted Location
...
### <a name="microsoft-visual-studio-proxy-behavior"></a>Microsoft Visual Studio Proxy Behavior
...
### <a name="global-assembly-cache-is-checked-first-then-the-local-folder"></a>Global Assembly Cache is Checked First, Then the Local Folder
...
### <a name="order-of-strings-in-sharedstringxml-is-not-maintained"></a>Order of Strings in Sharedstring.xml is Not Maintained

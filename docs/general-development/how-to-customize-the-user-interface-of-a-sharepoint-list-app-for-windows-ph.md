...
## <a name="create-a-sharepoint-list-app-for-user-interface-customizations"></a>Erstellen einer SharePoint-Listen-App für Anpassungen der Benutzeroberfläche
...
|Rush  <br/> |Boolescher Wert  <br/> |Nein  <br/> |
|Rufnummer  <br/> |Einzelne Textzeile (Text)  <br/> |Nein  <br/> |
   
Befolgen Sie die Verfahren unter  [Vorgehensweise: Erstellen eine Windows Phone SharePoint Liste app](how-to-create-a-windows-phone-sharepoint-list-app.md), um die Vorlage „Windows Phone - SharePoint-Listenanwendung" zu verwenden, um eine SharePoint-Listen-App als Anfangspunkt für die folgenden Benutzeroberflächenanpassungen zu verwenden. Geben Sie als Ziel-SharePoint-Liste für die App eine Liste an, die ein ähnliches Schema wie das in Tabelle 1 gezeigte hat.
  
    
    

## <a name="replace-textbox-controls-with-datepicker-controls"></a>Ersetzen von TextBox-Steuerelementen durch DatePicker-Steuerelemente
...
### <a name="to-replace-textbox-controls-with-datepicker-controls"></a>So ersetzen Sie TextBox-Steuerelemente durch DatePicker-Steuerelemente
...
6. Fügen Sie im XAML-Bereich des Designers eine Namespace-Deklaration hinzu, um die Steuerelemente in der Toolkit-Assembly vom `<phone:PhoneApplicationPage>`-Tag unterscheiden zu können.
...
## <a name="add-controls-to-support-custom-fill-in-options-for-choice-fields"></a>Hinzufügen von Steuerelementen zur Unterstützung von benutzerdefinierten Ausfülloptionen für Auswahlfelder
...
### <a name="to-add-a-class-to-support-data-conversion-for-choice-fields"></a>So fügen Sie eine Klasse zur Unterstützung der Datenkonvertierung für Choice-Felder hinzu
...
### <a name="to-add-a-property-member-to-the-edititemviewmodel-class"></a>So fügen Sie einen Eigenschaftenmember zur Klasse EditItemViewModel hinzu
...
### <a name="to-add-and-configure-ui-controls-for-entering-custom-choice-field-values"></a>So fügen Sie UI-Steuerelemente für das Eingeben benutzerdefinierter Choice-Feldwerte hinzu und konfigurieren diese

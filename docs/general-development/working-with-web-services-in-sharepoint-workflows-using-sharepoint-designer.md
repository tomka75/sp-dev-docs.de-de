...
-  <span data-ttu-id="e6de9-282">
  [Erste Schritte mit dem SharePoint REST-Dienst](http://msdn.microsoft.com/de-de/library/office/fp142380.aspx)</span><span class="sxs-lookup"><span data-stu-id="e6de9-282">[Get started with the SharePoint REST service](http://msdn.microsoft.com/de-de/library/office/fp142380.aspx)</span></span>

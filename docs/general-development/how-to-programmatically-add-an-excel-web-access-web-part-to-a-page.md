...
---
# <a name="how-to-programmatically-add-an-excel-web-access-web-part-to-a-page"></a>How to: Programmatically Add an Excel Web Access Web Part to a Page
...
### <a name="to-add-a-reference-to-microsoftofficeexcelwebuidll"></a>So fügen Sie einen Verweis auf „Microsoft.Office.Excel.WebUI.dll“ hinzu
...
## <a name="instantiating-a-web-part"></a>Instantiating a Web Part


### <a name="to-instantiate-the-excel-web-access-web-part"></a>To instantiate the Excel Web Access Web Part
...
### <a name="to-display-a-workbook-programmatically"></a>To display a workbook programmatically
...
2. Sie können eine Excel-Arbeitsmappe programmgesteuert mit dem folgenden Code anzeigen.

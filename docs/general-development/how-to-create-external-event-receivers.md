...
3. Erstellen Sie einen Abruf-Dienst, der überwacht die Änderungen in den Daten und SharePoint über diese Änderungen benachrichtigen.
...
## <a name="prerequisites-and-system-set-up"></a>Erforderliche Komponenten und System einrichten
...
## <a name="build-the-components-for-external-systems"></a>Die Komponenten für externe Systeme erstellen
...
## <a name="set-up-the-external-system"></a>Richten Sie das externe system
...
### <a name="attach-the-northwind-sample-database"></a>Fügen Sie die Nordwind-Datenbank
...
### <a name="create-the-subscription-store"></a>Erstellen von dem Abonnementspeicher
...
### <a name="create-the-change-store"></a>Erstellen Sie den Speicher ändern
...
### <a name="create-the-change-trigger"></a>Erstellen Sie den Auslöser ändern
...
Um den Trigger zu erstellen, führen Sie die folgende Abfrage aus.
...
### <a name="create-the-stored-procedures"></a>Erstellen der gespeicherten Prozeduren
...
## <a name="create-the-odata-service"></a>Erstellen des OData-Diensts
...
### <a name="to-create-the-wcf-data-service-application"></a>So erstellen Sie die WCF Data Service-Anwendung
...
### <a name="to-create-the-wcf-data-service"></a>Zum Erstellen der WCF-Dienst
...
### <a name="to-set-the-security-on-the-service"></a>Die Sicherheit für den Dienst festlegen
...
### <a name="create-the-subscribe-service-operation-optional"></a>Erstellen Sie den Vorgang Subscribe (optional)
...
## <a name="create-the-polling-service"></a>Erstellen des Umfragedienstes
<a name="bkmk_CreateThePollingService"> </a>

Der Abruf-Dienst ist ein Windowsdienst, der für die Abfrage der Änderungstabelle und erstellen und Senden von Benachrichtigungen zu SharePoint oder SharePoint Online an der angegebenen zustellungs-Adresse zuständig ist.
...
### <a name="to-compile-and-deploy-the-polling-service"></a>So kompilieren und stellen Sie den Dienst abrufen
...
## <a name="required-sharepoint-components"></a>Erforderliche Komponenten für SharePoint
<a name="bkmk_SharePointComponents"> </a>

Um das gesamte System abgeschlossen haben, müssen die folgenden Komponenten auf dem Server, auf dem SharePoint ausgeführt wird.
...
- **Externe Ereignisempfänger:** Der Remote- oder externen Ereignisempfänger ist die Sache, die Aktionen auf externe datenänderungen in SharePoint ermöglicht. Sie können Ereignisempfänger für externe Listen und für Entitäten erstellen.
...
## <a name="set-up-the-sharepoint-components"></a>Richten Sie die SharePoint-Komponenten
...
### <a name="to-create-a-new-visual-studio-2012-project"></a>Erstellen Sie ein neues Projekt von Visual Studio 2012
...
### <a name="to-add-a-new-external-content-type"></a>So fügen Sie einen neuen externen Inhaltstyp hinzu
...
- Klicken Sie im **Projektmappen-Explorer** öffnen Sie das Kontextmenü für das Projekt, und wählen Sie **Hinzufügen** und **Inhaltstypen für eine externe Datenquelle**.
    ...
    Weitere Informationen zum Erstellen externer Inhaltstypen finden Sie unter  [Gewusst wie: Erstellen eines externen Inhaltstyps aus einer OData-Quelle in SharePoint](how-to-create-an-external-content-type-from-an-odata-source-in-sharepoint.md).
...
### <a name="to-add-the-subscribe-method-to-the-external-content-type-xml"></a>So fügen Sie die Subscribe-Methode für den externen Inhaltstyp XML hinzu
...
### <a name="to-add-code-to-the-appjs-file-to-initiate-the-subscription"></a>Die Datei App.js, das Abonnement zu initiieren Code hinzu
...
### <a name="to-add-the-notifications-list"></a>So fügen Sie der Benachrichtigungsliste hinzu
...
### <a name="to-start-the-command-line-event-receiver"></a>Starten Sie den Command-Line-Ereignisempfänger
...
### <a name="to-deploy-the-app-to-sharepoint"></a>Zum Bereitstellen der app für SharePoint

...
1. <span data-ttu-id="6b47a-265">Wählen Sie im Feld **Filtertyp** die Option **Limit** aus.</span><span class="sxs-lookup"><span data-stu-id="6b47a-265">In the **Filter Type** box, select **Limit**.</span></span> 

...
## <a name="elements-of-a-kql-query"></a>Elemente einer KQL-Abfrage
...
## <a name="constructing-free-text-queries-using-kql"></a>Erstellen von Freitext-Abfragen mit KQL
...
### <a name="using-words-in-the-free-text-kql-query"></a>Verwenden von Wörtern in der Freitext-KQL-Abfrage
...
### <a name="using-phrases-in-the-free-text-kql-query"></a>Verwenden von Ausdrücken in der Freitext-KQL-Abfrage
...
## <a name="property-restriction-queries-in-kql"></a>Eigenschaftseinschränkung-Abfragen in KQL
...
### <a name="specifying-property-restrictions"></a>Angeben von Eigenschaftseinschränkungen
...
### <a name="specifying-property-names-for-property-restrictions"></a>Angeben von Eigenschaftsnamen für Eigenschaftseinschränkungen
...
### <a name="property-operators-that-are-supported-in-property-restrictions"></a>In Eigenschaftseinschränkungen unterstützte Eigenschaftsoperatoren
...
### <a name="specifying-property-values"></a>Angeben von Eigenschaftswerten
...
#### <a name="text-property-values"></a>Texteigenschaftstypen
...
#### <a name="property-values-in-the-full-text-index"></a>Eigenschaftswerte im Volltextindex
...
#### <a name="numerical-values-for-properties"></a>Numerische Werte für Eigenschaften
...
### <a name="date-or-time-values-for-properties"></a>Datums- oder Zeitwerte für Eigenschaften
...
#### <a name="relevant-date-intervals-supported-by-kql"></a>Von KQL unterstützte relevante Datumsintervalle
...
|:-----|:-----|
|heute  <br/> |Stellt den Zeitraum vom Anfang des aktuellen Tags bis zum Ende des aktuellen Tags dar.  <br/> |
...
### <a name="using-multiple-property-restrictions-within-a-kql-query"></a>Verwenden von mehreren Eigenschaftseinschränkungen innerhalb einer KQL-Abfrage
...
## <a name="kql-operators-for-complex-queries"></a>KQL-Operatoren für komplexe Abfragen
...
|**ODER** <br/> |Gibt Suchergebnisse zurück, die eine oder mehrere der angegebenen Freitext-Ausdrücke oder Eigenschaftseinschränkungen enthält. Sie müssen vor und nach dem **OR**-Operator einen gültigen Freitext-Ausdruck und/oder eine gültige Eigenschaftseinschränkung angeben.<br/> |
...
### <a name="proximity-operators"></a>Näherungsoperatoren
...
#### <a name="near-operator"></a>NEAR-Operator
...
#### <a name="onear-operator"></a>ONEAR-Operator
...
### <a name="synonym-operators"></a>Synonym-Operatoren
...
### <a name="wildcard-operator"></a>Platzhalterzeichen
...
### <a name="inclusion-and-exclusion-operators"></a>Ein- und Ausschluss-Operatoren
...
### <a name="dynamic-ranking-operator"></a>Dynamischer Rangfolge-Operator

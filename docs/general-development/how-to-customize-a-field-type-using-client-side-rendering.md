...
-  <span data-ttu-id="64c7f-193">
  [Vorgehensweise: Erstellen eines benutzerdefinierten Feldtyps](http://msdn.microsoft.com/en-us/library/bb862248.aspx)</span><span class="sxs-lookup"><span data-stu-id="64c7f-193">[How to: Create a Custom Field Type](http://msdn.microsoft.com/en-us/library/bb862248.aspx)</span></span>
    
  
-  <span data-ttu-id="64c7f-194">
  [ Exemplarische Vorgehensweise: Erstellen eines benutzerdefinierten Feldtyps](http://msdn.microsoft.com/en-us/library/bb861799.aspx)</span><span class="sxs-lookup"><span data-stu-id="64c7f-194">[Walkthrough: Creating a Custom Field Type](http://msdn.microsoft.com/en-us/library/bb861799.aspx)</span></span>

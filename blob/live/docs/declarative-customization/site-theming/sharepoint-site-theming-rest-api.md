# <a name="sharepoint-site-theming-rest-api"></a><span data-ttu-id="ba16c-101">SharePoint-Websitedesign: REST-API</span><span class="sxs-lookup"><span data-stu-id="ba16c-101">SharePoint site theming: REST API</span></span>

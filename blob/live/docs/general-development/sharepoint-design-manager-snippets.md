...
- <span data-ttu-id="56f20-111">Konfigurieren der Eigenschaften für diese Komponente</span><span class="sxs-lookup"><span data-stu-id="56f20-111">Configure the properties for that component.</span></span>

...
-  [<span data-ttu-id="7149b-210">Excel Services-Architektur</span><span class="sxs-lookup"><span data-stu-id="7149b-210">Excel Services Architecture</span></span>](excel-services-architecture.md)
